...
const UserNav = (props) => {
  return (
    <div >
        <NavComponents roomId={props.roomId} user={props.user} socket={props.socket} tab={ props.tab } repos={ props.repos } contentLoaded={ props.contentLoaded } content={ dataFormatter(props.fileStructure) } handleFileClick={ props.handleFileClick }/>
        ...
        <Button id="shareSession" 
            onClick={() => {
                    var el = document.createElement('textarea');
                    el.value = props.roomId;
                    // el.setAttribute('value', props.roomId);
                    //el.setAttribute('text', props.roomId);
            ...
            } outline color="secondary" type="button" size="lg" block > Share Session</Button>
