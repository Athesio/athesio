...
const UserNav = (props) => {
  return (
    <div >
      <NavComponents tab={ props.tab } repos={ props.repos } contentLoaded={ props.contentLoaded } content={ dataFormatter(props.fileStructure) } handleFileClick={ props.handleFileClick }/>
