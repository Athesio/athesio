...
class Room extends React.Component {
  ...
  changeTabs(e) {
    ...
    console.log(e.target.className.split("Span")[0]);
    // if(e.target.name) {
    //   this.setState({ clickedTab: e.target.name });
    // } else {
    //   this.setState({ clickedTab: e.target.className.split("Span")[0] });
    // }
  }
              ...
              <div className="row" >
                <div id="iconBar" >
                  <div className="text-center" >
                    <a name="Home" onClick={this.changeTabs} className="userSpan text-center icon" style={{ padding: '0px', color: '#f1f1f1' }} >&#9776;</a>
