    ...
    return (
      <div>
        <Switch>
          ...
          <ProtectedRoute path='/room/:id' component={Room} authStatus={false} />
          <ProtectedRoute path='/room/*' component={Room} authStatus={false} />
          <ProtectedRoute path='/selectroom' component={SelectRoom} authStatus={false} />
